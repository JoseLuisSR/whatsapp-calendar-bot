...
# ------------------------------------------------------------
# Create .env file (shared by docker-compose)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Create docker-compose.yml for PostgreSQL + n8n
# ------------------------------------------------------------
...
services:
  ...
  n8n:
    ...
    environment:
      ...
      # Public host configuration (Nginx will proxy requests)
      N8N_HOST: ${DOMAIN}
      N8N_PROTOCOL: https
    ...
    ports:
      # Bind only to localhost for security (Nginx will proxy traffic)
      - "127.0.0.1:5678:5678"
    volumes:
